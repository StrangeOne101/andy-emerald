...
enum
{
    ...
    FACILITY_CLASS_TOBY,
    FACILITY_CLASS_ADAM,
    FACILITY_CLASS_BB_PRIVATE,
    FACILITY_CLASS_WORKER,
    FACILITY_CLASS_ELECTRICIAN,
    FACILITY_CLASS_BUILDER,
    FACILITY_CLASS_INDOMITABLE,
    FACILITY_CLASS_OFFICER,
    FACILITY_CLASS_SKULL_GRUNT,
    FACILITY_CLASS_SKULL_LEADER,
    FACILITY_CLASS_PROFESSOR,
    FACILITY_CLASS_UNEMPLOYED,
    FACILITY_CLASS_STYLIST,
...
enum TrainerClassID
{
    ...
    TRAINER_CLASS_TOBY,
    TRAINER_CLASS_ADAM,
    TRAINER_CLASS_BB_PRIVATE,
    TRAINER_CLASS_WORKER,
    TRAINER_CLASS_ELECTRICIAN,
    TRAINER_CLASS_BUILDER,
    TRAINER_CLASS_INDOMITABLE,
    TRAINER_CLASS_OFFICER,
    TRAINER_CLASS_SKULL_GRUNT,
    TRAINER_CLASS_SKULL_LEADER,
    TRAINER_CLASS_PROFESSOR,
    TRAINER_CLASS_UNEMPLOYED,
    TRAINER_CLASS_STYLIST,
