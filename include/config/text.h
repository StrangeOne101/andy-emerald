...
#define TEXT_SPEED_MEDIUM_MODIFIER   3       // How fast the MID text speed option prints
#define TEXT_SPEED_FAST_MODIFIER     2       // How fast the FAST text speed option prints
