...
#define P_POKERUS_VISIBLE_ON_EGG         GEN_6 // Controls if eggs can show Pokérus symbol in summary screen (TRUE from gen 3 to 6, FALSE in gen 2,7 and 8)
...
#define P_POKERUS_INFECTION_ODDS         50          // Actual probability is POKERUS_INFECTION_ODDS/65536
