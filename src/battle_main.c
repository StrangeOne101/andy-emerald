...
const struct TrainerClass gTrainerClasses[TRAINER_CLASS_COUNT] =
{
    ...
    [TRAINER_CLASS_ADAM] = {_("DUNGEONMASTR"), 20 },
    [TRAINER_CLASS_TOBY] = {_("ROM ADMIN"), 15},
    [TRAINER_CLASS_BB_PRIVATE] = {_("PRIVATE"), 5},
    [TRAINER_CLASS_WORKER] = {_("WORKER"), 5},
    [TRAINER_CLASS_ELECTRICIAN] = {_("ELECTRICIAN"), 7},
    [TRAINER_CLASS_BUILDER] = {_("BUILDER"), 8},
    [TRAINER_CLASS_INDOMITABLE] = {_("INDOMITABLE"), 20, BALL_LUXURY},
    [TRAINER_CLASS_OFFICER] = {_("OFFICER"), 10},
    [TRAINER_CLASS_SKULL_GRUNT] = {_("TEAM SKULL"), 6},
    [TRAINER_CLASS_SKULL_LEADER] = {_("SKULL LEADER"), 10, BALL_ULTRA },
    [TRAINER_CLASS_PROFESSOR] = {_("PROFESSOR"), 10},
    [TRAINER_CLASS_UNEMPLOYED] = {_("UNEMPLOYED"), 1},
    [TRAINER_CLASS_STYLIST] = {_("STYLIST"), 7},
