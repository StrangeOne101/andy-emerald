...
const struct MoveInfo gMovesInfo[MOVES_COUNT_ALL] =
{
    ...
    [MOVE_FOCUS_ENERGY] =
    {
        .name = COMPOUND_STRING("Fck Around, Find Out"),
        .description = COMPOUND_STRING(
            "Do something dumb.\n"
            "See what happens."),
    ...
    [MOVE_SELF_DESTRUCT] =
    {
        .name = COMPOUND_STRING("Nuke Iran"),
        .description = COMPOUND_STRING(
            "Oil belongs to the great\n"
            "nation of the US!"),
        .effect = EFFECT_HIT,
    ...
    [MOVE_PUNCH] =
    {
        .name = COMPOUND_STRING("Punch"),
        .description = COMPOUND_STRING("Punch with your fists"),
        .effect = EFFECT_HIT,
        .power = 1,
        .type = TYPE_NORMAL,
        .accuracy = 100,
    ...
    [MOVE_CRY] =
    {
        .name = COMPOUND_STRING("Cry"),
        .description = COMPOUND_STRING("Cry with real tears"),
        .effect = EFFECT_DO_NOTHING,
        .power = 0,
        .type = TYPE_NORMAL,
        .accuracy = 100,
