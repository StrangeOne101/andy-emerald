const u16 gFacilityClassToPicIndex[] =
{
    ...
    [FACILITY_CLASS_UNEMPLOYED]         = TRAINER_PIC_UNEMPLOYED,
    [FACILITY_CLASS_STYLIST]            = TRAINER_PIC_STYLIST,
};
...
const enum TrainerClassID gFacilityClassToTrainerClass[] =
{
    ...
    [FACILITY_CLASS_UNEMPLOYED]         = TRAINER_CLASS_UNEMPLOYED,
    [FACILITY_CLASS_STYLIST]            = TRAINER_CLASS_STYLIST,
};
